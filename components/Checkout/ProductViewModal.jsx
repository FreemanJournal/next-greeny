...
export default function ProductViewModal(props) {
    ...
    return (
        ...
        >
            <ModalDialog>
            <button className="modal-close icofont-close" data-bs-dismiss="modal" onClick={props.onHide}> <FaTimes /> </button>
            ...
            {/* <div className="modal fade show" id="product-view" style={{ display: `${showModal ? 'block' : 'none'}`, paddingRight: `${showModal && '16px'}` }} role={showModal && "dialog"} aria-modal={showModal && "true"}>
                <div className="modal-dialog">
                    <div className="modal-content">
                        <button className="modal-close icofont-close" data-bs-dismiss="modal" onClick={() => setShowModal(prv => !prv)}> <FaTimes /> </button>
                        <div className="product-view">
                            <div className="row">
                                <div className="col-md-6 col-lg-6">
                                    <div className="view-gallery">
