            ...
            <div className="col-lg-12">
                <div className="navbar-content">
                    <ul className="navbar-list">
                        ...
                        <li className="navbar-item dropdown-megamenu"><a className="navbar-link dropdown-arrow"
                                href="#">shop</a>
                        ...
                        <li className="navbar-item dropdown"><a className="navbar-link dropdown-arrow"
                                href="#">authentic</a>
                            <ul className="dropdown-position-list">
